                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" action="{{ route('admin#updatePizza',$pizza->pizza_id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" value="{{ old('name',$pizza->pizza_name) }}" placeholder="Enter Pizza Name">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" name="price" value="{{ old('price',$pizza->price) }}" placeholder="Enter Price">
                              @if ($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" name="discount" value="{{ old('discount',$pizza->discount_price) }}" placeholder="Enter Discount Price">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" name="waitingTime" value="{{ old('waitingTime',$pizza->waiting_time) }}" placeholder="Enter Waiting Time">
