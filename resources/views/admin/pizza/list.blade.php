            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools d-flex">
                    <a href="{{ route('admin#pizzaDownload') }}"> <button class="btn btn-sm btn-success mt-1 me-3">Download CSV</button></a>
                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('admin#editPizza',$item->pizza_id) }}"><button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button>
                          </a>
                          ...
                          <a href="{{ route('admin#pizzaInfo',$item->pizza_id)}}"><button class="btn btn-sm bg-primary text-white"><i class="fas fa-eye"></i></button></a>
                        </td>
                    </tr>
                    @endforeach
                    @endif
